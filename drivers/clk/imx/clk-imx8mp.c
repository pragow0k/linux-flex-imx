...
static int imx8mp_clocks_probe(struct platform_device *pdev)
{
	...
	hws[IMX8MP_CLK_USB_ROOT] = imx_clk_hw_gate2_shared2("usb_root_clk", "osc_32k", ccm_base + 0x44d0, 0, &share_count_usb);
	hws[IMX8MP_CLK_USB_SUSP] = imx_clk_hw_gate2_shared2("usb_suspend_clk", "hsio_axi", ccm_base + 0x44d0, 0, &share_count_usb);
